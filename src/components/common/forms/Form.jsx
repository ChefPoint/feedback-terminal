...
class Form extends React.Component {
  ...
  handleInputChange = ({ currentTarget: input }) => {
    ...
    const errorMessage = validation.validateInput(input, this.schema);
    if (errorMessage) {
  ...
  prepareFormSubmission = e => {
    ...
    const result = validation.validateData(this.state.data, this.schema);
   ...
   */
  renderButton(label, block, variant, disabled, onClick) {
    return (
      <Button
        label={label}
        block={block}
